...
Tags: facebook, social, share, google, like, socializer, bookmark, follow,floating share buttons, social bookmarking, share widget, email, recommend, promote, twitter, del.icio.us, digg, language, translate, links, reddit, sharing, tweet, google translate, livejournal, tinyURL, evernote
...
You can see Socializer! in action, e.g. at [Live Desktop Gadgets](https://windowslivegadgets.com/gallery/)
...
You can also create manually [occasional share-links](https://www.thefreewindows.com/11487/incorporating-socializer-web-scripts-software-creating-manual-sharelinks/) independently of the regular buttons, whenever you need to have such references in an article of yours.
...
If you have a personal, business or fan page in Facebook and / or Twitter, you can let Socializer! add a **Follow** button in the Share bars. You can [see live how Follow works](https://windowslivegadgets.com/gallery/)
...
* You may like to have a look at Socializer! [Home](https://www.socializer.info) & [Plugin Page](https://www.thefreewindows.com/5598/socializer-share-WordPress-posts-pages/) for more information or support.

* To increase your readership further (and rapidly), do not miss the free [Social Share Motivator](https://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/), a plugin able to **demand** the sharing of your blog as a form of reward for the content you publish, even refuse access to your pages, if you so decide.
...
* Except for the Socializer! images that you see here at the Screenshots section, you can view a live demo at the home page of [Live Destkop Gadgets](https://windowslivegadgets.com/gallery/)



== Frequently Asked Questions ==

You can read [Frequent Questions and Answers](https://www.thefreewindows.com/6035/socializer-WordPress-frequent-questions-answers/). 

You are welcome to [ask a question yourself](https://www.thefreewindows.com/about/contact/). 
...
* Changes to the code that will let the users of Socializer connect to the new server at [www.socializer.info](https://www.socializer.info). The old server will continue to work for some months, but you should upgrade.
...
Fixed minor compatibility requirements for newer WordPress.

= 12 =

Added SSL support. You should upgrade especially if you'd like to comply with Google's demand for increased security.
...
Upgrade to this version to connect to the new server at [www.socializer.info](https://www.socializer.info)
