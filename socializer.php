...
Version: 12.9
Plugin URI: https://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/
Description: Socializer! is a free, fast, flexible, easy and very efficient plugin that will help your visitors share your posts on top social networks, including Facebook, Twitter, by eMail, even translate them, get HTML links, short links, and more! Check the <a href="https://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/" target="_blank">Plugin Home</a>.
...
<a style="border:none;border:0;text-decoration:none;" href="https://www.socializer.info/" target="_blank"><img src="<?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>sclog.gif" style="border:none;border:0;padding-bottom:5px;" alt="Home of Socializer!"></a>

<span style="font-size:18px;font-weight:normal;"><a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;" href="https://www.socializer.info/share.asp?docurl=https://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/&doctitle=Socializer! for Wordpress" target="_blank">Share the Socializer!</a> &nbsp;&&nbsp; <a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;" target="_blank" href="https://www.socializer.info/follow.asp?docurlf=https://www.facebook.com/TheFreeWindows&docurlt=https://twitter.com/TheFreeWindows&myname=TheFreeWindows">Follow!</a></span>
</h1>
...
<label><input type="radio" name="tfw_floatsize" value="large" <?php if(get_option('tfw_floatsize')=="large") echo "checked";?>> <span style="letter-spacing:1px;">Display counts</span> in the Floating bar (Note that <strong>Twitter won't offer counts anymore!</strong>)</label>
<br>
...
<b>Style Properties of the Floating Bar</b> &nbsp; <img src="<?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>csseditor.png" style="border:none;border:0;margin:0;height:35px;"> <a href="https://www.thefreewindows.com/socializer-style-editor/floating.php" target="_blank" style="text-decoration:none;color:#2b95ff;">Customize with the Style Editor</a>
<br>
...
<b>Style Properties of Sidebar Widgets</b> &nbsp; <img src="<?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>csseditor.png" style="border:none;border:0;margin:0;height:35px;"> <a href="https://www.thefreewindows.com/socializer-style-editor/sidebar.php" target="_blank" style="text-decoration:none;color:#2b95ff;">Customize with the Style Editor</a><br>
...
<b>Style Properties</b> &nbsp; <img src="<?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>csseditor.png" style="border:none;border:0;margin:0;height:35px;"> <a href="https://www.thefreewindows.com/socializer-style-editor/content.php" target="_blank" style="text-decoration:none;color:#2b95ff;">Customize with the Style Editor</a>
<br>
...
If you have a personal or business page in Facebook or Twitter you can paste here the address of each of your profiles in these networks to let Socializer! add a "Follow" button among the sharing buttons.
<br>&nbsp;<br>
...
<input style="cursor:pointer;letter-spacing:7px;color:#2b95ff;-moz-border-radius: 17px;border-radius: 17px;border:1px solid white;background:white;padding:5px 19px;font-size:18px;" type="submit" name="info_update" value="<?php _e(' Save your settings '); ?>" /> &nbsp;  &nbsp;&nbsp;  &raquo;&nbsp; <a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;font-size:18px;" href="https://www.socializer.info/share.asp?docurl=https://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/&doctitle=Socializer! for Wordpress" target="_blank">Share the Socializer!</a> &nbsp;&nbsp;  &raquo;&nbsp; <a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;font-size:18px;" target="_blank" href="https://www.socializer.info/follow.asp?docurlf=https://www.facebook.com/TheFreeWindows&docurlt=https://twitter.com/TheFreeWindows">Follow!</a>
...
<div style="padding: 10px 20px 0 45px;line-height:199%;">
 ...
 &nbsp;&nbsp;  &raquo; <a style="color:#2b95ff;text-decoration:none;letter-spacing:1px;" href="https://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/" target="_blank">Plugin Page</a> &nbsp;&&nbsp; <a style="color:#2b95ff;text-decoration:none;letter-spacing:1px;" href="https://www.thefreewindows.com/6035/socializer-wordpress-frequent-questions-answers/" target="_blank">FQA</a>
<br>
&nbsp;&nbsp;  &raquo; Check the free <a style="color:#2b95ff;text-decoration:none;letter-spacing:1px;" href="https://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/" target="_blank">Social Share Motivator</a> plugin, for a different sharing policy
<br>&nbsp;<br>

<div align="center" style="text-align:center;margin-top:30px;"> &nbsp;  &nbsp;  &nbsp; <a style="color:silver;text-decoration:none;font-weight:bold;font-size:20pt;letter-spacing:3px;" href="https://www.socializer.info/" target="_blank">www.socializer.info</a></div>
...
Function SocializerNow_func($atts){
	...
	$the_social_stldiv = stripslashes(str_replace('.',chr(46),$trmdiv));
  	...
  	if (( $profabn != "" ) ||  ( $protwin != "" ))  {
    	$followbuttonn = '<td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><a title="Follow!" style="border:none;" href="https://www.socializer.info/follow.asp?docurlf='. $profabn .'&docurlt='. $protwin .'&myname='. $proname .'" target="_blank"><img src="'.	WP_CONTENT_URL .'/plugins/'. plugin_basename(dirname(__FILE__)) .'/follow.png" title="Follow!" style="padding:0;margin:0;border:none;border:0;box-shadow:none;background-color:transparent;background-image:none;"></a></td>';
} else {
	$followbuttonn = ' ';
};	
$flourl = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
	$theShortSoc = '<div id="SocializerNow">
	<div id="fb-root"></div><script type="text/javascript">
				FB.XFBML.parse();
			</script><table style="border-collapse: separate;'.$the_social_stldiv.'"><tr>
			<td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><a class="twitter-share-button" data-count="'. $twinowsize .'">Tweet</a></td><td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><fb:like layout="'. $fbnowsize .'" action="like" show_faces="false" share="true"></fb:like></td>
			'.$followbuttonn.'
			<td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><a title="Share in more social networks, email, translate, and more!" style="border:none;" href="https://www.socializer.info/share.asp%3Fdocurl='. $flourl .'&doctitle='. $MyTitle .'" target="_blank"><img src="'.	WP_CONTENT_URL .'/plugins/'. plugin_basename(dirname(__FILE__)) .'/sharemore.gif" title="Share in top social networks, email, translate, and more!" style="padding:0;margin:0;border:none;border:0;box-shadow:none;background-color:transparent;background-image:none;"></a></td></tr></table></div>';
...
class SocializerWidget extends WP_Widget {
    ...
    function SocializerWidget() {
        ...
        parent::__construct('SocializerWidget', __('Socializer!'), $widget_ops);
    }
	...
	$tfw_wsize = get_option('tfw_wsize');
  	if ( $tfw_wsize == "small" ) {
    		...
    		$fbwshrcode = "<span style=\"padding:0 3px 0 1px;\"><fb:share-button type=\"button\"></fb:share-button></span>";
  	} else {
    		$twiwsize = "vertical";
    		$fbwsize = "box_count";
    		$fbwshr = "false";
	...
	$the_social_stlwdiv = stripslashes(str_replace('.',chr(46),$trmwdiv));
  	...
  	if (( $profabw != "" ) ||  ( $protwiw != "" ))  {
    	$followbuttonw = '<a title="Follow!" style="border:none;" href="https://www.socializer.info/follow.asp?docurlf='. $profabw .'&docurlt='. $protwiw .'&myname='. $pronamew .'" target="_blank"><img src="'.	WP_CONTENT_URL .'/plugins/'. plugin_basename(dirname(__FILE__)) .'/follow.png" title="Follow!" style="border:none;border:0;box-shadow:none;padding-bottom:9px;"></a><br>';
} else {
	$followbuttonw = ' ';
};	
	$socpath = WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/';
...
<div id="SocializerW">		
	<div id="fb-root"></div><script type="text/javascript">
			...
			<td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><?=$fbwshrcode ?></td>
			<td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><fb:like layout="<?=$fbwsize ?>" action="like" show_faces="false" share="<?=$fbwshr ?>"></fb:like></td></tr><tr>
			<td align="left" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;" valign="bottom"><a class="twitter-share-button" data-count="<?=$twiwsize ?>">Tweet</a></td><td align="left" valign="bottom" style="text-align:left;padding:0;border:none;background-color:transparent;background-image:none;vertical-align:bottom;"><?=$followbuttonw ?><a title="Share in top social networks, email, translate, and more!" style="border:none;" href='https://www.socializer.info/share.asp?docurl=<?=$flourl ?>&doctitle=<?php if (is_home() || is_front_page()) { bloginfo("name"); echo " - "; bloginfo("description"); } else { wp_title(" - ",TRUE,"right"); } ?>' target="_blank"><img src="<?=$socpath?><?=$imid?>.gif" title="Share in top social networks, email, translate, and more!" style="padding:0;margin:0;border:none;border:0;box-shadow:none;background-color:transparent;background-image:none;"></a></td></tr></table></div>        
<?php
    }
}
...
class SocializerFloatWidget extends WP_Widget {
    ...
    function SocializerFloatWidget() {
        ...
        parent::__construct('SocializerFloatWidget', __('Socializer! Float'), $widget_ops);
    }
...
$tfw_stlfloatwdiv = get_option('tfw_stlfloatwdiv');
	...
	$the_social_stlfloatwdiv = stripslashes(str_replace('.',chr(46),$trmfloatwdiv));	
  	...
  	if (( $profab != "" ) ||  ( $protwi != "" ))  {
    	$followbutton = '<tr><td align="left" style="padding-top:7px;padding-bottom:7px;text-align:left;border:none;background-color:transparent;background-image:none;vertical-align:top !important;" valign="top"><a title="Follow!" style="border:none;" href="https://www.socializer.info/follow.asp?docurlf='. $profab .'&docurlt='. $protwi .'&myname='. $pronamef .'" target="_blank"><img src="'.	WP_CONTENT_URL .'/plugins/'. plugin_basename(dirname(__FILE__)) .'/follow.png" title="Follow!" style="padding-top:0;padding-bottom:0;border:none;border:0;box-shadow:none;background-color:transparent;background-image:none;"></a></td></tr>';
} else {
	$followbutton = ' ';
};	
	global $socdetect;
...
$flourl = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    		$fbwshrcode = "<span style=\"padding:0 3px 0 2px;\"><fb:share-button  type=\"button\"></fb:share-button></span>";
?>
...
<div id="SocializerFloatW" style="<?=$socmob ?>;max-width:133px;position:fixed;float:left;<?=$the_social_stlfloatwdiv ?>;">	<div id="fb-root"></div><script type="text/javascript">
				FB.XFBML.parse();
			</script><table cellpadding="0" border="0" style="padding:0;border:none;border-collapse: separate;border-spacing:0 10px;margin:0;"><tr><td align="left" style="padding-top:0;padding-bottom:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;text-align:left;" valign="top"><fb:like layout="<?=$fbfloatsize ?>" action="like" show_faces="false" share="false"></fb:like></td></tr><tr><td align="left" style="padding-top:0;padding-bottom:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;text-align:left;" valign="top"><?=$fbwshrcode ?></td></tr><?=$followbutton ?><tr><td align="left" style="padding-top:0;padding-bottom:0;border:none;background-color:transparent;background-image:none;vertical-align:top !important;text-align:left;" valign="top" nowrap><a class="twitter-share-button" data-count="<?=$twifloatsize ?>">Tweet</a></td></tr><tr><td align="left" style="padding-top:0;padding-bottom:0;border:none;background-color:transparent;background-image:none;vertical-align:bottom;text-align:left;" valign="bottom"><a title="Share in top social networks, email, translate, and more!" style="border:none;" href='https://www.socializer.info/share.asp?docurl=<?=$flourl ?>&doctitle=<?php if (is_home() || is_front_page()) { bloginfo("name"); echo " - "; bloginfo("description"); } else { wp_title(" - ",TRUE,"right"); } ?>' target="_blank"><img src="<?=$socpath?><?=$imid?>.gif" title="Share in top social networks, email, translate, and more!" style="padding-top:0;padding-bottom:0;border:none;border:0;box-shadow:none;background-color:transparent;background-image:none;"></a></td></tr></table></div>
...
function socializer_settings_link($links) { 
  $settings_link = '<a href="options-general.php?page=socializer!">Settings</a> | <a href="https://www.thefreewindows.com/6035/socializer-wordpress-frequent-questions-answers/">FQA</a>'; 
...
add_filter('the_content', 'tfw_generate', 99);
?>